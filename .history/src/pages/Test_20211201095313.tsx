...
const Test: NextPage = () => {
  ...
  const createKey = () => {
    ...
    getCreateKey(imageData.name, size, deviceKey, formData, inputUploadKeys, imageData);
  ...
  return (
    <>
      ...
      <br/><br/>
      <PrimaryButton label={"WATCH response"} onClick={() => {console.log(deviceData); console.log(uploadKeys) }}/>
      <br/><br/><hr/><br/><br/>
